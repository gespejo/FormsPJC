/*
 * $Id: PDFObject.java,v 1.4 2009/01/16 16:07:33 tomoke Exp $
 *
...
public class PDFObject {
     ...
     */
    public HashMap getDictionary() throws IOException {
        if (type == INDIRECT) {
    ...
    public String toString() {
        try {
            if (type == INDIRECT) {
                return "Indirect to #" + ((PDFXref) value).getID();
            } else if (type == BOOLEAN) {
    ...
    public PDFObject dereference() throws IOException {
        if (type == INDIRECT) {
            ...
            if (obj == null || obj.value == null) {
                ...
                obj = owner.dereference((PDFXref) value);
