/*
 * $Id: PDFFunction.java,v 1.4 2009/01/03 17:17:11 tomoke Exp $
 *
...
public abstract class PDFFunction {
        ...
        throws IOException
    {
        ...
        if (domainObj == null) {
            throw new PDFParseException("No Range specified in function!");
        }
                             ...
                             float[] outputs, int outputOffset) 
    {
        ...
        // check the outputs
        if (outputs.length - outputOffset < getNumOutputs()) {
